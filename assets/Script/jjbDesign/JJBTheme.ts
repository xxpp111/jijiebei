...
const T: { [k: string]: any } = {
    "metal-dark": {
        ...
        panelBg: ["#1c2a3e", 158], panelEdge: ["#c7d1de", 61], dropEdge: ["#d8b15a", 107],
        win: "#4f9d72", bonus: "#6f86bd", lose: "#a3434a", serif: true,
    },
    "metal-light": {
        bgA: "#e2e9f1", bgB: "#bcc7d6", ink: "#15233a", muted: "#5d6b80",
        accent: "#a9761f", onAccent: "#ffffff",
        panelBg: ["#ffffff", 199], panelEdge: ["#15233a", 69], dropEdge: ["#a9761f", 128],
        win: "#2f8d5c", bonus: "#3f63b8", lose: "#b23b3b", serif: true,
    },
    "sc2-dark": {
        bgA: "#101c20", bgB: "#05090b", ink: "#dfeae6", muted: "#7f9389",
        accent: "#56cf8c", onAccent: "#062013",
        panelBg: ["#1e302e", 164], panelEdge: ["#78968c", 76], dropEdge: ["#56cf8c", 102],
        win: "#56cf8c", bonus: "#52a7c4", lose: "#d06b6b", serif: false,
    },
    "sc2-light": {
        bgA: "#dde8e4", bgB: "#b4c5bf", ink: "#14241f", muted: "#54665d",
        accent: "#1f8a55", onAccent: "#ffffff",
        panelBg: ["#f8fbf9", 209], panelEdge: ["#14241f", 69], dropEdge: ["#1f8a55", 128],
        win: "#1f8a55", bonus: "#2f7fa0", lose: "#b23b3b", serif: false,
    },
    "minimal-dark": {
        bgA: "#16181d", bgB: "#0a0b0e", ink: "#f1f3f6", muted: "#888e9a",
        accent: "#4f8ff5", onAccent: "#04101f",
        panelBg: ["#ffffff", 9], panelEdge: ["#ffffff", 36], dropEdge: ["#ffffff", 51],
        win: "#3fae74", bonus: "#4f8ff5", lose: "#e0606e", serif: false,
    },
    "minimal-light": {
        bgA: "#ffffff", bgB: "#edeff2", ink: "#14171c", muted: "#69707c",
        accent: "#2f6fd6", onAccent: "#ffffff",
        panelBg: ["#ffffff", 255], panelEdge: ["#14171c", 36], dropEdge: ["#14171c", 56],
        win: "#1f9d63", bonus: "#2f6fd6", lose: "#d34a58", serif: false,
    },
};
...
export function getTheme(style: string, mode: string): Theme {
    ...
    return {
        ...
        win: c(d.win), bonus: c(d.bonus), lose: c(d.lose),
    };
}
