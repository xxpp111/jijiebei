...
import { startRandomSession, getSessionMatches, exposeObsbarDebug, jjbLive, setVerdict, getScore } from '../logic/jjbSession';
...
export function ObsScreen({ style, mode }: { style: string; mode: string }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px 0', gap: 14 }}>
      ...
      <ObsBar style={style} mode={mode} rows={rows} wins={wins} total={total} />
