// [legacy/web 副本] 源 = assets/Script/jjbDesign/JJBData.ts（XP/Cocos 知识成果，原件只读保留，致敬原作者）。
// web 运行期适配：内部 import `../jijie2/JijieData` → `./JijieData`（同目录副本）。逻辑逐字保留。详见同目录 README.md。
